        ...
        <div :id="wrapperId" class="simple-typeahead input-contain" v-if="type == 'select' || type == 'multiSelect'">
            <input
                ...
                :style="[
                    ...
                    isListVisible ? (sideInputType ? 'border-radius: 0.5rem 0 0 0;border: 2px solid' : 'border-radius: 0.5rem 0.5rem 0 0;border: 2px solid') : '',
                ]"
            ...
            >
                ...
                >
                    ...
                    <span class="simple-typeahead-list-item-text" :data-text="optionProjection(item)" v-html="boldMatchText(optionProjection(item))" v-else></span>
                </div>
