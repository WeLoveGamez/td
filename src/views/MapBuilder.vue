<template>
    <div id="game" style="height: 100vh; position: relative" @click.stop="selectedTileIndices = null">
        <div class="d-flex justify-content-center pt-2" style="position: relative; width: 100%">
            ...
            <div class="button" @click.stop="generatePath('basic')">Auto generate basic path</div>
            <div class="button" @click.stop="generatePath('complex')">Auto generate complex path</div>
            <div class="button" @click.stop="clearPath()">clear Path</div>
        </div>
        <!-- game -->
        <div>
            ...
            <div class="card-body d-flex row col-12">
                ...
                <div class="col-8">
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
                        ...
                        <button style="margin-left: -50px" class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button style="margin-right: -30px" class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
